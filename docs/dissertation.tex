...
\begin{document}
	...
	The similarity can occur for multiple reasons. It can be due to the current pathways being the most optimal one given the set of constraints posed by the environment of the cells. 
	
	In \cite{theoretical} it is found that the metabolic network of modern cell (the Embden-Meyerhof-Parnas (EMP) pathway) is optimized to provide the highest possible ATP production flux, while maintaining a high kinetic efficiency. 
